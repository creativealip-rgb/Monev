...
import { X, Edit2, Trash2, Calendar, CreditCard, Tag, TrendingUp, DollarSign } from "lucide-react";
import { format } from "date-fns";
import { id } from "date-fns/locale";
import { formatCurrency, cn } from "@/frontend/lib/utils";
import { Transaction, Budget, Goal } from "@/types"; // Adjust path if needed
    ...
    return (
        <AnimatePresence>
            <motion.div
                ...
                animate={{ opacity: 1 }}
                exit={{ opacity: 0 }}
                className="fixed inset-0 bg-black/50 z-[10005] flex items-end sm:items-center justify-center p-4 sm:p-0"
                onClick={onClose}
            >
                <motion.div
                    initial={{ y: "100%" }}
                    ...
                    className="bg-white w-full max-w-md rounded-t-3xl sm:rounded-3xl p-6 pb-24 sm:pb-6"
