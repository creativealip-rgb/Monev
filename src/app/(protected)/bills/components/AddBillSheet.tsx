                        ...
                        >
                            <div className="flex items-center justify-between mb-6">
                                ...
                                <button
                                    onClick={handleClose}
                                    disabled={loading}
                                    className="w-10 h-10 rounded-full bg-slate-100 dark:bg-slate-800 flex items-center justify-center text-slate-500 dark:text-slate-400 hover:bg-slate-200 dark:hover:bg-slate-700 transition-colors disabled:opacity-50"
                                >
                                    <X size={20} />
                                </button>
                            </div>
