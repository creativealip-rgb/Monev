# Monev Design System: Style Guide

The Monev design system is a modern, financial-focused aesthetic that combines **Glassmorphism**, **Fluid Animations**, and a **Vibrant Color Palette** (Sky Blue & Cyan) to create a premium, clean, and interactive user experience.
...
### 2. Functional Colors
*   **Success**: `142 76% 36%` (Emerald) - Used for income and positive growth.
*   **Danger/Destructive**: `0 84% 60%` (Rose) - Used for expenses and delete actions.
*   **Warning**: `38 92% 50%` (Amber) - Used for alerts and budgets.
...
### 1. The "Glass" Utility
Monev relies heavily on backdrop blur and subtle borders to create depth.
```css
.glass {
...
> [!TIP]
> **Key Consistency Rule**: Always use **Sky Blue** as the primary focus, and use **Emerald/Rose** strictly for financial status. Maintain a high `backdrop-blur` (at least 20px) for all floating UI elements.
