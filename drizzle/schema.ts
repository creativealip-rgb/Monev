...
export const bills = sqliteTable("bills", {
	...
	isActive: integer("is_active").default(1).notNull(),
	isSubscription: integer("is_subscription").default(0).notNull(),
...
export const userSettings = sqliteTable("user_settings", {
	...
	isAppLockEnabled: integer("is_app_lock_enabled").default(0).notNull(),
	isBiometricEnabled: integer("is_biometric_enabled").default(0).notNull(),
	hideBalance: integer("hide_balance").default(0).notNull(),
